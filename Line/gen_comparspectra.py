...
gs = fig.add_gridspec(2, 3, width_ratios=[2., .8, .8], height_ratios=[1.,1.])
...
for ioffset  in list(range(len(alloffsets))):
    ...
    addprofile(fig_axspec,hducubeobs,hducubemod,label,xoffset=xoffset,yoffset=yoffset,VisibleXaxis=VisibleXaxis,VisibleYaxis=VisibleYaxis,restfreq=restfreq)
